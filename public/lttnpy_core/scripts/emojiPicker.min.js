                                        ...
                                        },
                                        {
                                            ...
                                            value: function generateElements(emojiInput) {
                                                var clickLink = function clickLink(event) {
                                                    ...
                                                    var caret = new Caret(emojiInput);
                                                    if ($(emojiInput).attr('contenteditable') == 'true') {
                                                        caretPos = caret.getPos();
                                                        const thisHtml = $(emojiInput).html().trim();
                                                        $(emojiInput).html(thisHtml + ' ' + event.target.innerHTML);
                                                        emojiPicker.style.display = 'none';
                                                        'undefined' != typeof angular && angular.element(emojiInput).triggerHandler('change');
                                                        setCaret(emojiInput, (caretPos + 2));
                                                    } else {
                                                        (emojiInput.value =
                                                ...
                                                (emojiTrigger.style.position = 'absolute'),
                                                    ...
                                                    (emojiTrigger.onclick = function() {
                                                        'none' === emojiPicker.style.display && (emojiPicker.style.display = 'block'),
                                                            emojiPicker.focus();
                                                    }),
